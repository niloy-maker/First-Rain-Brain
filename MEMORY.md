...
## 🟡 STRATEGIC DECISIONS — OPEN (not yet resolved)

| Decision | Status |
|---|---|
| Agency channel partnerships | Under evaluation — 90-day data collection |
| Sales hunter hire | Required — not yet actioned |
| Ideal account architecture (5 large vs 8–10 mid) | Leaning fewer/larger |
| Monica's long-term creative role | Transitioning — reassess annually |
| International expansion governance | Doha protocol designed, not yet tested on next project |
...
| Person | Key note |
|---|---|
| Mangesh | Primary creative anchor — single point of failure risk |
| Sonal | Entire finance function — single point of failure risk |
| Komal | 1 month in — groom for project delivery + design QA |
| Dhruv | 1 month in — PM pipeline + outbound. Tier 2 ABM executor. |
| Shilpa | Mobility restricted — async only. Do NOT assign field or outbound tasks. |
...
| Layer | Status |
|---|---|
| Master Prompt v2 | ✅ Live in claude.ai Project |
| P_Projects.md | ✅ Live |
| A_Areas.md | ✅ Live |
| R_Resources.md | ✅ Live |
