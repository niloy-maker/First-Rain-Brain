...
- **Milestone delta pull** (validated 2026-07-09; `notion-query-*` tools are
  ...
  2. For each T-row that was PENDING for any project in the morning briefing,
  ...
  3. Compare `__YES__` cells against morning-briefing pending list.
     Difference = midday completions to report as deltas.
