...
- Elliott Ebara: PO required before Closed Won. Verbal ≠ revenue. Receivable ₹10.23L expected 2–7 May 2026.
...
- Monthly burn FY27: ₹25,50,000 | Operating cash: ₹22,64,418 (CRITICAL — 0.89 months)
- Treasury: ₹1,38,26,443 (real buffer) | Total receivables: ₹63,89,964 (updated post-W15)
- W15 collected: ₹4.5L (Messung + Mosil cleared)

## Verified project facts
- Bechem BME Delhi 8–9 Apr: Delivered. Exec: Chinmay.
- Labguard Analytica 22–24 Apr: Active. Exec: Shilpa. Balance ₹1.36L (receivable triggered).
- Mosil IDMC Lucknow 23–24 Apr: Active. Exec: Dhruv.
- Messung Smart Home 28–30 Apr: Active. Exec: Shilpa. Concept DRAFT — Mangesh review pending.
- Amaara Vitafoods Europe ~5 May: CM% unconfirmed. Exec: Shilpa.
